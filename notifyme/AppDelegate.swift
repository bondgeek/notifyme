...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didReceiveLocalNotification notification: UILocalNotification) {
        ...
        let notifyCount = UIApplication.sharedApplication().scheduledLocalNotifications.count
        println("Received Local Notification. Number of notifications left: \(notifyCount)")
